...
var _call = __webpack_require__(141);

var _call2 = _interopRequireDefault(_call);

var _put = __webpack_require__(137);

var _put2 = _interopRequireDefault(_put);

var _fork = __webpack_require__(143);

var _fork2 = _interopRequireDefault(_fork);

var _join = __webpack_require__(144);
...
var TYPE__TICK = exports.TYPE__TICK = '__INTERVAL_TICK__';

//Description, The thing you yield
var tick = exports.tick = function tick(fnc) {
    return {
        type: TYPE__TICK,
        payload: {
            fnc: fnc
...
var generateTickFunctions = exports.generateTickFunctions = function generateTickFunctions() {
    ...
    var effectProcessor = void 0;

    var processor = function processor(effect, _ref) {
        var effectGeneratorProcessor = _ref.effectGeneratorProcessor;

        effectProcessor = effectGeneratorProcessor;

        if (effect.payload.fnc instanceof GeneratorFunction) {
            return new Promise(function (resolve) {
                return subscribers.push([effect.payload.fnc, resolve]);
            });
        } else {
            ...
            setInterval(function () {
                ...
                subscribers.forEach(function (_ref2) {
                    ...
                    if (fnc instanceof GeneratorFunction) {
                        var res = effectProcessor(fnc(dt), { dispatch: store.dispatch });
                        res.then(function (isComplete) {
                            if (isComplete) {
                                subscribers = subscribers.filter(function (_ref4) {
                        ...
                        var isComplete = fnc(dt);
                        if (isComplete) {
                            subscribers = subscribers.filter(function (_ref6) {
    ...
    return { processor: processor, middleware: middleware };
};
...
var _baseGetTag = __webpack_require__(351);

var _baseGetTag2 = _interopRequireDefault(_baseGetTag);

var _getPrototype = __webpack_require__(356);

var _getPrototype2 = _interopRequireDefault(_getPrototype);

var _isObjectLike = __webpack_require__(358);
...
var baseGetTag = __webpack_require__(139),
    getPrototype = __webpack_require__(371),
...
var _isGenerator = __webpack_require__(93);
...
var processor__call = exports.processor__call = function processor__call(effect, _ref) {
    var dispatch = _ref.dispatch,
    ...
    if (typeof effect.payload.fnc === 'function') {
        ...
        var res = (_effect$payload = effect.payload).fnc.apply(_effect$payload, _toConsumableArray(effect.payload.args));
...
exports.takeDamage = exports.seekStep = exports.incrementConjure = exports.createExplosion = exports.createConjureFireball = exports.createFireball = exports.metaEntitiesSelector = exports.removeEntity = exports.createEntity = exports.fireballExplosion = exports.seek = exports.conjureFireball = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _effects = __webpack_require__(94);

var _tick2 = __webpack_require__(95);

var conjureTime = 2000; //ms
var conjureFireball = exports.conjureFireball = function conjureFireball(owner) {
    return (/*#__PURE__*/regeneratorRuntime.mark(function _conjureFireball() {
            var conjureFireball, fireball;
            return regeneratorRuntime.wrap(function _conjureFireball$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.next = 2;
                            return (0, _effects.put)(createConjureFireball(owner));

                        case 2:
                            conjureFireball = _context2.sent;
                            _context2.next = 5;
                            return (0, _tick2.tick)( /*#__PURE__*/regeneratorRuntime.mark(function _tick(dt) {
                                var getPercent;
                                return regeneratorRuntime.wrap(function _tick$(_context) {
                                    while (1) {
                                        switch (_context.prev = _context.next) {
                                            case 0:
                                                _context.next = 2;
                                                return (0, _effects.put)(incrementConjure(conjureFireball, dt / conjureTime));

                                            case 2:
                                                getPercent = _context.sent;
                                                return _context.abrupt('return', 1 <= getPercent());
                        ...
                        case 5:
                            _context2.next = 7;
                            return (0, _effects.put)(removeEntity(conjureFireball));

                        case 7:
                            _context2.next = 9;
                            return (0, _effects.put)(createFireball(owner));

                        case 9:
                            fireball = _context2.sent;
                            return _context2.abrupt('return', fireball);
            ...
            }, _conjureFireball, this);
        })
    );
};

var speed = 0.01; //x per ms
var fireballRadius = 0.1;
var seek = exports.seek = function seek(owner, target) {
    return (/*#__PURE__*/regeneratorRuntime.mark(function _seek() {
            return regeneratorRuntime.wrap(function _seek$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            return (0, _tick2.tick)( /*#__PURE__*/regeneratorRuntime.mark(function _tick(dt) {
                                var distance;
                                return regeneratorRuntime.wrap(function _tick$(_context3) {
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            case 0:
                                                _context3.next = 2;
                                                return (0, _effects.put)(seekStep(owner, target, dt * speed));

                                            case 2:
                                                distance = _context3.sent;
                                                return _context3.abrupt('return', fireballRadius > distance());
...
var explosion_duration = 1500; //ms
// uses fireballRadius
var fireballExplosion = exports.fireballExplosion = function fireballExplosion(x) {
    return (/*#__PURE__*/regeneratorRuntime.mark(function _fireballExplosion() {
            var explosion;
            return regeneratorRuntime.wrap(function _fireballExplosion$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            _context6.next = 2;
                            return (0, _effects.put)(createExplosion(x));

                        case 2:
                            explosion = _context6.sent;
                            _context6.next = 5;
                            return (0, _tick2.tick)( /*#__PURE__*/regeneratorRuntime.mark(function _tick(dt) {
                                var getPercent;
                                return regeneratorRuntime.wrap(function _tick$(_context5) {
                                    while (1) {
                                        switch (_context5.prev = _context5.next) {
                                            case 0:
                                                _context5.next = 2;
                                                return (0, _effects.put)(incrementConjure(explosion, dt / conjureTime));

                                            case 2:
                                                getPercent = _context5.sent;
                                                return _context5.abrupt('return', 1 <= getPercent());
                        ...
                        case 5:
                            _context6.next = 7;
                            return (0, _effects.put)(removeEntity(explosion));
...
var createFireball = exports.createFireball = function createFireball(owner) {
    return createEntity({
        kind: 'spell',
        name: 'fireball',
        dmg: 2,
...
var createConjureFireball = exports.createConjureFireball = function createConjureFireball(owner) {
    return createEntity({
...
var createExplosion = exports.createExplosion = function createExplosion(x) {
    return createEntity({
        kind: 'spell',
        name: 'explosion',
        percent: 0,
...
var incrementConjure = exports.incrementConjure = function incrementConjure(entity, percent) {
    return {
        ...
        meta: {
            selector: function selector(state) {
                return state.entities[entity().id].percent;
            }
        }
    };
};

var seekStep = exports.seekStep = function seekStep(entity, target, distance) {
    return {
        type: 'SEEK_STEP',
        entity: entity(),
        target: target(),
        ...
        meta: {
            selector: function selector(state) {
                return Math.abs(entity().x - target().x);
            }
        }
    };
};

var takeDamage = exports.takeDamage = function takeDamage(entity, attack) {
    return {
        type: 'TAKE_DAMAGE',
        entity: entity(),
        attack: attack()
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(46), __webpack_require__(130)(module)))
...
var _reduxYieldEffect = __webpack_require__(365);

var _effects = __webpack_require__(94);

var _call = __webpack_require__(145);

var _tick = __webpack_require__(95);

var _actions = __webpack_require__(146);

var _fireball = __webpack_require__(375);
...
var _metaSelector = __webpack_require__(378);

var _metaSelector2 = _interopRequireDefault(_metaSelector);

var _actionLogger = __webpack_require__(379);

var _actionLogger2 = _interopRequireDefault(_actionLogger);

var _graphics = __webpack_require__(380);
...
document.addEventListener('DOMContentLoaded', function () {
    var _createYieldEffectMid;

    var tickFncs = (0, _tick.generateTickFunctions)();

    var store = (0, _redux.createStore)(_reducer2.default, (0, _redux.applyMiddleware)((0, _reduxYieldEffect.createYieldEffectMiddleware)((_createYieldEffectMid = {}, _defineProperty(_createYieldEffectMid, _call.TYPE__CALL, _call.processor__call), _defineProperty(_createYieldEffectMid, _tick.TYPE__TICK, tickFncs.processor), _createYieldEffectMid)), tickFncs.middleware(10), (0, _actionLogger2.default)('#logger'), _metaSelector2.default));
    ...
    var me = store.dispatch((0, _actions.createEntity)({
        id: 0,
        name: 'jason',
        maxhp: 30,
        hp: 30,
    ...
    var enemy = store.dispatch((0, _actions.createEntity)({
        id: 1,
        name: 'badGuy',
        maxhp: 20,
        hp: 20,
    ...
    var timeoutFireballMe = function timeoutFireballMe() {
        if (me().hp < 0 || enemy().hp < 0) return;

        store.dispatch((0, _fireball2.default)(me, enemy)());
        setTimeout(timeoutFireballMe, 2000 + Math.random() * 2000);
    };
    setTimeout(timeoutFireballMe, 1000);

    var timeoutFireballEnemy = function timeoutFireballEnemy() {
        if (me().hp < 0 || enemy().hp < 0) return;

        store.dispatch((0, _fireball2.default)(enemy, me)());
...
var _Symbol2 = __webpack_require__(134);

var _Symbol3 = _interopRequireDefault(_Symbol2);

var _getRawTag = __webpack_require__(354);

var _getRawTag2 = _interopRequireDefault(_getRawTag);

var _objectToString = __webpack_require__(355);
...
var _freeGlobal = __webpack_require__(353);
...
var _overArg = __webpack_require__(357);
...
var _createYieldEffectMiddleware = __webpack_require__(366);
...
function createEffectGeneratorProcessor(effectProcessors) {
  ...
  return function effectGeneratorProcessor(effectGenerator, _ref2) {
    ...
    function handlePreviousEffectResult(prevEffectResult) {
      ...
      var value = _effectGenerator$next.value;
      var done = _effectGenerator$next.done;
    ...
    function handlePreviousEffectError(prevEffectError) {
      ...
      var value = _effectGenerator$thro.value;
      var done = _effectGenerator$thro.done;
...
exports.default = function (owner, target) {
    return (/*#__PURE__*/regeneratorRuntime.mark(function _fireball() {
            var fireball;
            return regeneratorRuntime.wrap(function _fireball$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            console.log('START: ', target().hp);
                            _context.next = 3;
                            return (0, _effects.call)((0, _actions.conjureFireball)(owner));
                        ...
                        case 3:
                            ...
                            _context.next = 7;
                            return (0, _effects.call)((0, _actions.seek)(fireball, target));

                        case 7:
                            console.log('FIREBALL FOUND TARGET (fireball.x, target.x)', fireball().x, target().x);

                            _context.next = 10;
                            return (0, _effects.put)((0, _actions.takeDamage)(target, fireball));

                        case 10:
                            _context.next = 12;
                            return (0, _effects.put)((0, _actions.removeEntity)(fireball));

                        case 12:
                            console.log('TARGET DMGED', target().hp);

                            _context.next = 15;
                            return (0, _effects.fork)((0, _actions.fireballExplosion)(target().x));
...
var _entities = __webpack_require__(377);
...
exports.default = function () {
    ...
    switch (type) {
        ...
        case 'INCREMENT_CONJURE':
            return _extends({}, state, _defineProperty({}, entity.id, _extends({}, state[entity.id], {
...
var getOutput = function getOutput(action) {
...
exports.default = function (ctx, state, dt) {
    ...
    var drawPerson = function drawPerson(person, color) {
    ...
    var draw = {
        jason: function jason(_jason) {
            return drawPerson(_jason, c.green);
        },
        badGuy: function badGuy(_badGuy) {
            return drawPerson(_badGuy, c.purple);
        },
        conjuringFireball: function conjuringFireball(conjure) {
            ctx.lineWidth = width;
        ...
        fireball: function fireball(_fireball) {
            ctx.fillStyle = c.orange;
            ctx.lineWidth = width;
            ctx.strokeStyle = c.red;
            ctx.beginPath();
            ctx.arc(_fireball.x * 50, y, 25, 0, Math.PI * 2);
            ctx.fill();
            ctx.stroke();
        },
        explosion: function explosion(_explosion) {
            ctx.fillStyle = c.orange;
            ctx.globalAlpha = 1 - _explosion.percent;
            ctx.globalAlpha = 0.1 + (0.5 - Math.round(_explosion.percent * 100) % 26 / 50);
            ctx.beginPath();
            ctx.arc(_explosion.x * 50, y, 75, 0, Math.PI * 2);
            ctx.fill();
        }
    };
